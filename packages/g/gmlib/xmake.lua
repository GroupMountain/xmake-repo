package("gmlib")
    ...
    add_resources(
        "1.6.0",
        "SDK-static",
        "https://github.com/GroupMountain/GMLIB-Release/releases/download/v1.6.0/SDK-static.zip",
        "4b45939ae35ec58854d574a8b76374c0b262de6bbb95385f522e49ced6bd3567"
    )
    add_versions("C:1.7.0", "84e1748d38992953addf97d985ec3fed5b419db468e595b52c32e6e0970ad5b5")
    add_resources(
        "1.7.0",
        "SDK-static",
        "https://github.com/GroupMountain/GMLIB-Release/releases/download/v1.7.0/SDK-static.zip",
        "2b1768a51ba3b24b54ae0de437d66ca3fff7947a5865e1257ba05a49d9ba4077"
    )
    add_versions("C:1.9.0", "cb4cd0ece061ed4cf3c87a229599698580f6cbfdf42fcaaa123a2ba513f6e26a")
    add_resources(
        "1.9.0",
        "SDK-static",
    ...
    add_versions("C:26.10.0", "94859443a39d4f1bbe3d58ed1c8aa759cdff229e10dcd5cac6075e80724500ef")
    add_resources(
        "26.10.0",
        "SDK-static",
        "https://github.com/GroupMountain/GMLIB-Release/releases/download/v26.10.0/SDK-static.zip",
        "202d7d42ee36509f7118d817152878c0af23ab93ef34ddc2c7adb31d60f8c76d"
    )
    add_versions("C:26.20.0", "d426c4233c2928deddff43ce6fbffad8a8384c8ede92e7c8bd2acebeae9adc36")
    add_resources(
        "26.20.0",
        "SDK-static",
        "https://github.com/GroupMountain/GMLIB-Release/releases/download/v26.20.0/SDK-static.zip",
        "f16480106a6a39611f3a7838db3993625562b93dd02b41eff5d00805b202fa7c"
    )
    add_versions("C:26.20.1", "c725de03d64caa11396a6326a71e99bbad1c7a951632937c992e1022873c2df3")
    add_resources(
        "26.20.1",
        "SDK-static",
    ...
    add_versions("C:26.40.0", "7b2b7627b5f45349a8ceb101f02577f792b28a4f7235124a4725c34f7f43f685")
    add_resources(
        "26.40.0",
        "SDK-static",
        "https://github.com/GroupMountain/GMLIB-Release/releases/download/v26.40.0/SDK-static.zip",
        "18f227771087378ae120c9744048366f6240bdcf7385d465ba668cd5e5a12260"
    )
    add_versions("C:26.51.0", "0ae0e98a4516c85ecef8443b90bdba2bcd5f6e3c147bec634102db9611341593")
    add_resources(
        "26.51.0",
        "SDK-static",
        "https://github.com/GroupMountain/GMLIB-Release/releases/download/v26.51.0/SDK-static.zip",
        "0af68daf028b710223281a61c45ff59aba5514bf1255a32bb9af1585dcae7ffc"
    )
